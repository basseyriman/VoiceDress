      ...
      {!compact && (
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-mist">
            Upload clear photos of your clothes (laid flat or on a hanger) or screenshots of items you've bought or want to try (Amazon, Zara, SHEIN, Temu, ASOS, eBay, etc.) — select
